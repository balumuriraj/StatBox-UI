<template>
  <div class="container">
    <div class="hero">
      <div class="hero-body">
        <p class="title">Browsing Movies..</p>
        <p class="sub-title">Displaying
          <span @click="showFilter = !showFilter">{{selectedGenreNames.join(", ")}}</span> movies between the years
          <span @click="showFilter = !showFilter">{{minYear}} - {{maxYear}}</span> and rating of
          <span @click="showFilter = !showFilter">{{minRating}} - {{maxRating}}</span>
        </p>
      </div>
    </div>
    <div class="body">
      <div class="row">
        <div class="buttons">
          ...
          <div class="sort-container" v-if="showSort" @click="showSort = !showSort">
            ...
            <div @click="sortOrder = 'title'">Alphabetical</div>
          ...
          <div class="genres-container">
            <div class="title-block">
              ...
              <div class="button" @click="resetFilter()">
                <span>clear</span> <font-awesome-icon icon="times" class="icon"></font-awesome-icon>
              </div>
            </div>            
            <ul>
